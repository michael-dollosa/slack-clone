...
const Sidebar = ({
  ...
  const userEmail =
    userDetails && userDetails.data ? userDetails.data.email : null;
      ...
      <div className="sidebar-option-container">
        ...
        <section className="sidebar-option-channelList">
          ...
          <div className="sidebar-option-list-header">
            <ArrowDropDownIcon
              className={!toggleChannelDropdown ? `icon` : `icon rotate`}
              onClick={handleToggleChannelDropdown}
            />
            <h1>Channels</h1>
          </div>
        ...
        <section className="sidebar-option-userList">
          ...
          >
            <NavLink to={`/user/${userId}`}>
              <SidebarOption
                key={userId}
                Icon={`https://picsum.photos/id/${userId}/20`}
                title={userEmail}
                optionType="user"
              />
            </NavLink>
